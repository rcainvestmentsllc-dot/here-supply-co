...
export const metadata: Metadata = {
  ...
  description: "A practical setup for the man who keeps reaching for his phone at home, even when he wants to be present with his family.",
...
const articleData = {
  ...
  mainEntityOfPage: "https://ironcompassinstitute.com/resources/how-to-stop-checking-your-phone-at-home",
};
...
export default function StopCheckingPhoneAtHome() {
  return <main id="main-content" className={styles.article}>
    ...
    <header className={styles.hero}>
      ...
      <p className={styles.byline}>By Chris Avera · From the Iron Compass Focus Protocol</p>
    </header>
    ...
    <section className={styles.layout}>
      <aside className={styles.aside}>
        ...
        <Link href="/focus">See the complete 72-hour reset →</Link>
      </aside>
      <article className={styles.body}>
        <p>I do not think most men need another lecture about screen time. We already know when the phone is getting too much of us. The harder part is the small automatic reach that happens before a conscious decision.</p>
        ...
        <div className={styles.steps}>
          ...
          <section className={styles.step}><span>04</span><div><h3>Protect one real window</h3><p>Start with dinner, bedtime, the first twenty minutes after arriving home, or one conversation with your wife. Make the window visible and small enough to repeat.</p></div></section>
        </div>
    ...
    <section className={styles.cta}><div><span>FOCUS PROTOCOL</span><h2>Turn one good idea into a short, usable reset.</h2></div><div><p>Focus Protocol guides you through four practical changes over 72 hours, then helps you decide which ones belong in your real life.</p><Link href="/focus">See Focus Protocol <b>→</b></Link></div></section>
    <Footer />
  </main>;
}

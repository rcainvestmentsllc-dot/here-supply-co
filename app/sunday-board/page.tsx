...
export const metadata: Metadata = {
  ...
  description: "A free printable weekly check-in for couples who want a clearer house, a calmer week, and fifteen honest minutes together.",
...
export default function SundayBoard() {
  return <main className="site"><Header />
    <section className="interior-hero sunday-hero"><p className="kicker">THE FREE SUNDAY BOARD MEETING</p><h1>Put the week<br /><em>on the table.</em></h1><p>A printable weekly check-in for couples who want a clearer house, a calmer week, and fifteen honest minutes together.</p><div className="hero-buttons compact-hero-actions"><a className="button primary" href="/downloads/sunday-board-meeting.pdf" download>Download the printable <span>↓</span></a><a className="text-link" href={SKOOL.group} target="_blank" rel="noreferrer">Get the free video walkthrough <span>↗</span></a></div><small className="hero-detail">No account is needed for the printable. The short recorded walkthrough is free inside Skool.</small></section>
    <section id="worksheet" className="worksheet-section"><div className="worksheet-copy"><p className="section-label">A REAL PLACE TO START</p><h2>Phones away.<br />A notebook between you.</h2><p>Connection first. Then the things that usually stay in both your heads: meals, money, projects, kids, the calendar, time together, and the shared goal that matters this week.</p><p className="free-note">This one is free because a better Sunday night can change a whole week. Download the printable with no account. If you want the short walkthrough Chris and Rhea recorded together, it is free inside Skool.</p><div className="split-actions"><a className="button dark" href="/downloads/sunday-board-meeting.pdf" download>Download the printable <span>↓</span></a><a className="quiet-link" href={SKOOL.group} target="_blank" rel="noreferrer">Get the free video walkthrough <span>↗</span></a></div></div><div className="worksheet-image"><img src="/assets/sunday-board-gamma.png" alt="The full Sunday Board Meeting worksheet" /></div></section>

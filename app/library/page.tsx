...
export const metadata: Metadata = {
  ...
  description: "A private course for two people who are tired of being in the same room and somewhere else. A three day attention reset plus nine lessons. $99, one time.",
...
const coreProduct = {
  ...
  description: "A private, self-paced Here Supply Co. course with the Focus Protocol, three movements, nine visual lessons, practical exercises, a complete print-first course book, and separate field tools.",
...
export default function Library() {
  return <main id="main-content" className="site"><JsonLd data={coreProduct} /><Header />
    <section className="core-hero">
      <div><p className="kicker">WHEN YOUR PHONE IS TAKING MORE THAN IT GIVES</p><h1>Your phone is a tool.<br /><em>You are not.</em></h1><p>A private course for two people who are tired of being in the same room and somewhere else. It starts with the 72-hour Focus Protocol, then gives you nine practices for the ordinary moments where attention actually gets lost. Kids or no kids. One of you can start it alone.</p><div className="hero-buttons">{coreCheckoutReady ? <a className="button primary" href={CHECKOUT.core}>Get All the Way Here · $99 <span>→</span></a> : <Link className="button primary" href="/sunday-board#get-board">Start free while checkout opens <span>→</span></Link>}<a className="text-link" href="#curriculum">See what is inside <span>↓</span></a></div><small>{coreCheckoutReady ? "Founding-edition price. One-time purchase. Private access. 14-day refund window." : "The paid checkout is not open yet. The free meeting guide is available now."}</small></div>

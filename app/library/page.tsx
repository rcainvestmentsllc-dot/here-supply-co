...
export default function Library() {
  return <main id="main-content" className="site"><JsonLd data={coreProduct} /><Header />
    <section className="core-hero">
      <div><p className="kicker">A HERE SUPPLY CO. COURSE</p><h1>Come all the way<br /><em>back to your life.</em></h1><p>All the Way Here is one private, self-paced course for people who are tired of being physically present while their attention, pressure, or unfinished work is somewhere else.</p><div className="hero-buttons">{coreCheckoutReady ? <a className="button primary" href={CHECKOUT.core}>Get All the Way Here · $99 <span>→</span></a> : <Link className="button primary" href="/sunday-board#get-board">Start free while checkout opens <span>→</span></Link>}<a className="text-link" href="#curriculum">See the full course <span>↓</span></a></div><small>{coreCheckoutReady ? "Founding-edition price. One-time purchase. Private access. 14-day refund window." : "The paid checkout is not open yet. The free meeting guide is available now."}</small></div>
    ...
    <section className="offer-section"><div className="offer-intro"><p className="section-label">ONE CLEAR PATH</p><h2>Start free.<br />Then go <em>deeper.</em></h2><p>The Sunday Board Meeting gives you one useful conversation. All the Way Here is the complete course when you want a fuller practice.</p></div><div className="offer-stack offer-stack-simple"><article className="offer-card free-offer"><span>01 · START FREE</span><h3>Sunday Board Meeting</h3><p>The original Chris and Rhea video plus a printable 15-minute conversation for two people sharing a life or household.</p><Link href="/sunday-board">Watch and get the free guide <b>→</b></Link></article><article id="core" className="offer-card core-offer"><span>02 · $99 FOUNDING EDITION</span><h3>All the Way Here</h3><p>One private visual course for attention, pressure, work, home, relationships, friendship, and the practices that bring them together.</p><strong>$99 <small>one time</small></strong><p className="offer-note">The attention reset, nine lessons, and a 16-page printable workbook. Private access at your own pace with a 14-day refund window.</p><p className="offer-value-note">$99 is below the $143.26 average cash-pay psychotherapy rate reported in a 2024 national analysis. Insurance, sliding scales, and local fees vary. This course is education, not therapy, and it is not a substitute for qualified professional care. <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC11412241/" target="_blank" rel="noreferrer">See the study ↗</a></p>{coreCheckoutReady ? <a href={CHECKOUT.core}>Get All the Way Here <b>→</b></a> : <Link href="/sunday-board">Start free while checkout opens <b>→</b></Link>}</article></div></section>

    <section className="faq-section"><div><p className="section-label">PLAIN ANSWERS</p><h2>Know what you are<br /><em>buying.</em></h2><p>All the Way Here is one complete course, delivered privately in your browser. These are the questions that matter before checkout.</p></div><div className="faq-list"><details><summary>Where did Focus go?<span>+</span></summary><p>The strongest attention-reset practices are now included at the beginning of this complete course. There is no separate $29 decision.</p></details><details><summary>Why $99?<span>+</span></summary><p>It is a one-time price for nine lessons, the complete attention reset, a 16-page workbook, a one-page field card, and practical family tools you can reuse. It costs less than the average national cash-pay psychotherapy rate reported in one 2024 analysis, but it is not counseling and does not replace professional care.</p></details><details><summary>What happens after I pay?<span>+</span></summary><p>Checkout opens your private All the Way Here course home. You can watch the introductions, open every visual lesson, mark your progress, and type in or print the workbook. Your access link is also sent by email.</p></details><details><summary>Is this a subscription?<span>+</span></summary><p>No. All the Way Here is a one-time purchase with private, self-paced access.</p></details><details><summary>What if it is not right for me?<span>+</span></summary><p>Request a refund within 14 calendar days of purchase. <Link href="/policies#refund">Read the refund policy.</Link></p></details></div></section>

    <section className="core-closing"><p className="section-label">START HERE</p><h2>Do not buy a better version<br />of yourself. <em>Practice being here.</em></h2><p>Start with the free weekly guide. When you want the complete practice, All the Way Here is the one next step.</p><Link className="button primary" href="/sunday-board">Get the free weekly guide <span>→</span></Link></section>
    <Footer />
  </main>;
}
